...
<b> • Pʀᴏғᴇssᴏʀ :</b> {message.from_user.mention}
...
"""
    answers.append(
        InlineQueryResultArticle(
            ...
            thumb_url="https://telegra.ph/file/b3b93c518f93437dfb258.jpg",
            input_message_content=InputTextMessageContent(
                msg, parse_mode=ParseMode.HTML, disable_web_page_preview=True
            ),
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton("──「 Pʀᴏғᴇssᴏʀ-Dᴀᴅᴅʏ 」──", callback_data="helper")]]
            ),
        )
    )
    return answers
